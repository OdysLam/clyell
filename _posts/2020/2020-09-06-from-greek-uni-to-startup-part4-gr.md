...
Kαθώς τελειώνουμε και αναλογιζόμαστε το επόμενο βήμα στην αγορά εργασίας, για να καθαρίσουμε στο μυαλό μας τι θέλουμε, μπορούμε να προσπαθήσουμε να απαντήσουμε στις ακόλουθες ερωτήσεις:
...
Μπορούμε να επικοινωνήσουμε με όλους και να ζητήσουμε μια σύντομη συνάντηση, μια κουβέντα. Θυμήσου πως όλοι θέλουν να βοηθήσουν ένα νέο απόφοιτο, ειδικά χρειάζεται εαν απλά μια μικρή βοήθεια στην κατεύθυνση ώστε να κεφαλαιοποιήσει την σκληρή εργασία που έχει ήδη κάνει.
...
Μάλιστα, [έρευνες](http://blog.idonethis.com/negativity-bias/) έχει δείξει πως το μυαλό μας τείνει να δίνει μεγαλύτερη σημασία στα αρνητικά γεγονότα από οτι στα θετικά. Έτσι, όσο όμορφη και αν είναι η ζωή μας, εάν δεν γιορτάζουμε τις νίκες αλλά μένουμε στις ήττες μας, θα είμαστε δυστυχισμένοι.
